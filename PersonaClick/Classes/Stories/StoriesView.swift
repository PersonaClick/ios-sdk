...
public class StoriesView: UIView, UINavigationControllerDelegate {
    ...
    /**
     Multi-instance overload (R3): resolves the SDK instance for `shopId` from the `PersonaClick` registry
    ...
    public func configure(shopId: String? = nil, mainVC: UIViewController, code: String) {
        ...
        sdkAwaitCancellable = PersonaClick.awaitInstance(for: shopId) { [weak self] sdk in
            DispatchQueue.main.async {
