...
public extension PersonalizationSDK {
    ...
    func recommend(blockId: String, currentProductId: String? = nil, imageSize: String? = nil, timeOut: Double?, completion: @escaping (Result<RecommenderResponse, SDKError>) -> Void) {
