...
/**
 ...
 instance by `shop_id` is in place and tested. The public `PersonaClick.initialize/instance(for:)/register`
...
internal final class SdkRegistry {
    ...
    private let queue = DispatchQueue(label: "com.personaClick.sdkRegistry", attributes: .concurrent)
