...
/**
 The push lifecycle event a host reports through `PersonaClick.handlePush(_:event:)`.
 ...
 `PersonaClick.handlePush`. Superset of the Android `PushEventType` (received/clicked): iOS keeps the separate
